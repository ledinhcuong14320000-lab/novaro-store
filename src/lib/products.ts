...
export const products: Product[] = [
  ...
  {
    id: "p22",
    slug: "jacquard-weave-shirt",
    sku: "NV-SH-022",
    category: "shirts",
    name: { en: "Jacquard Weave Shirt", km: "អាវត្បាញលំនាំលាក់" },
    description: {
      en: "A short-sleeve shirt woven with a subtle self-tone jacquard pattern that only reveals itself in the light — a quiet texture upgrade over a plain weave, sharp enough for evenings out.",
      km: "អាវដៃខ្លីត្បាញលំនាំពណ៌រូបភាពលាក់ បង្ហាញខ្លួនតែពេលមានពន្លឺបញ្ចាំង — បន្ថែមវាយនភាពស្ងាត់ស្ងៀមលើសពីក្រណាត់ធម្មតា ស័ក្តិសមសម្រាប់ល្ងាចចេញក្រៅ។",
    },
    care: { en: "Cotton blend. Machine wash cold, iron on low heat.", km: "កប្បាសលាយ។ លាងម៉ាស៊ីនទឹកត្រជាក់ អ៊ុតកម្តៅទាប។" },
    price: 17,
    sizes: ["S", "M", "L", "XL", "XXL"],
    colors: [
      { name: { en: "Burgundy Red", km: "ក្រហមទំពាំងបាយជូរ" }, hex: "#6b1f28" },
      { name: { en: "Ivory White", km: "ស ក្រែម" }, hex: "#eae6da" },
      { name: { en: "Onyx Black", km: "ខ្មៅអូនិច" }, hex: "#17140f" },
      { name: { en: "Deep Navy", km: "ខៀវចាស់ជ្រៅ" }, hex: "#1c2740" },
    ],
    images: [
      img("1781320955095_2540855462470973882_g2624158010987206290_9021d8a10e0ff5e50e94d913373cbe2c.jpg"),
      img("1781320955718_2540855462470973882_g2624158010987206290_da9a01f0d5bfada6dd259457fc3c3235.jpg"),
      img("1781320956123_2540855462470973882_g2624158010987206290_9a4af8393fe9eee9372dc72a33a501ff.jpg"),
      img("1781320956468_2540855462470973882_g2624158010987206290_6676ed3a8ea7e9eb62bb77df9bb2d6bd.jpg"),
    ],
    stock: 25,
    isNew: true,
  },
  {
    id: "p23",
    slug: "baroque-print-shirt",
    sku: "NV-SH-023",
    category: "shirts",
    name: { en: "Baroque Print Shirt", km: "អាវបោះពុម្ពលំនាំបារ៉ូក" },
    description: {
      en: "A short-sleeve shirt printed with an ornate baroque floral motif and finished with a chest pocket — a statement piece for those who want their shirt to do the talking.",
      km: "អាវដៃខ្លីបោះពុម្ពលំនាំផ្កាបារ៉ូកលម្អិត និងមានប្រអប់ក្រណាត់នៅទ្រូង — ជាអាវសម្គាល់ខ្លួនសម្រាប់អ្នកចង់ឱ្យអាវនិយាយសម្រាប់ខ្លួនឯង។",
    },
    care: { en: "Cotton blend. Machine wash cold, iron on low heat.", km: "កប្បាសលាយ។ លាងម៉ាស៊ីនទឹកត្រជាក់ អ៊ុតកម្តៅទាប។" },
    price: 17,
    sizes: ["S", "M", "L", "XL", "XXL"],
    colors: [
      { name: { en: "Black Baroque", km: "បារ៉ូកខ្មៅ" }, hex: "#1c1a17" },
      { name: { en: "Navy Baroque", km: "បារ៉ូកខៀវ" }, hex: "#202a3a" },
      { name: { en: "Olive Baroque", km: "បារ៉ូកអូលីវ" }, hex: "#4a4f3a" },
      { name: { en: "Sand Baroque", km: "បារ៉ូកខ្សាច់" }, hex: "#cbb896" },
    ],
    images: [
      img("1783909218713_4967340355098325783_g2624158010987206290_becc23e422c821622f08a848904e4af0.jpg"),
      img("1783909219853_4967340355098325783_g2624158010987206290_edb05d8e1f25083c2634c99e0644d237.jpg"),
      img("1783909221074_4967340355098325783_g2624158010987206290_30feb9a11a314d79e571747abfd0480e.jpg"),
      img("1783909223075_4967340355098325783_g2624158010987206290_f4ce51ba60ef55f4673a469a28eb73ad.jpg"),
    ],
    stock: 20,
    isNew: true,
  },
  {
    id: "p24",
    slug: "abstract-brushstroke-shirt",
    sku: "NV-SH-024",
    category: "shirts",
    name: { en: "Abstract Brushstroke Shirt", km: "អាវលំនាំវាយគំនូរអរូបី" },
    description: {
      en: "A short-sleeve shirt printed with a bold abstract brushstroke pattern in earthy tones — an artful statement piece that pairs easily with denim or plain trousers.",
      km: "អាវដៃខ្លីបោះពុម្ពលំនាំវាយគំនូរអរូបីដ៏លេចធ្លោក្នុងសម្លេងពណ៌ដីធម្មជាតិ — ជាអាវសម្គាល់ខ្លួនមានលក្ខណៈសិល្បៈ ងាយផ្គុំជាមួយខោខូវប៊យ ឬខោធម្មតា។",
    },
    care: { en: "Cotton blend. Machine wash cold, iron on low heat.", km: "កប្បាសលាយ។ លាងម៉ាស៊ីនទឹកត្រជាក់ អ៊ុតកម្តៅទាប។" },
    price: 17,
    sizes: ["S", "M", "L", "XL", "XXL"],
    colors: [
      { name: { en: "Storm Grey", km: "ប្រផេះព្យុះ" }, hex: "#8f8f8d" },
      { name: { en: "Ivory White", km: "ស ក្រែម" }, hex: "#ece8de" },
      { name: { en: "Sand Beige", km: "ខ្សាច់លឿង" }, hex: "#d9c9a8" },
      { name: { en: "Deep Navy", km: "ខៀវចាស់ជ្រៅ" }, hex: "#1e2c47" },
    ],
    images: [
      img("1784771892450_2257238558574597291_g2624158010987206290_92f75e5ae40f0ea86f34d4806c75fb28.jpg"),
      img("1784771893828_2257238558574597291_g2624158010987206290_9d3f38ede7b1e9fe414da261e7489325.jpg"),
      img("1784771896589_2257238558574597291_g2624158010987206290_1bf8f32dd6ea714423baf5fbab1ce9a6.jpg"),
      img("1784771900402_2257238558574597291_g2624158010987206290_a6a756b70a11b6091912cc3e91dc94f9.jpg"),
    ],
    stock: 24,
    isNew: true,
  },
  {
    id: "p25",
    slug: "vintage-floral-denim-polo",
    sku: "NV-PL-025",
    category: "polos",
    name: { en: "Vintage Floral Denim Polo", km: "អាវប៉ូឡូខូវប៊យ លំនាំផ្កាបុរាណ" },
    description: {
      en: "A washed denim-effect polo overlaid with a botanical branch print, finished with a quarter-button placket and structured collar — rugged texture meets refined detail.",
      km: "អាវប៉ូឡូបែបខូវប៊យវាយសើម តុបតែងដោយលំនាំមែកឈើផ្កាបុរាណ បំពាក់ដោយប៊ូតុងកអាវពាក់កណ្តាល និងកអាវរឹងបន្តិច — វាយនភាពរឹងមាំ ជួបនឹងលម្អិតដ៏ថ្លៃថ្នូរ។",
    },
    care: { en: "Cotton-denim blend. Machine wash cold, iron on low heat.", km: "កប្បាសខូវប៊យលាយ។ លាងម៉ាស៊ីនទឹកត្រជាក់ អ៊ុតកម្តៅទាប។" },
    price: 17,
    sizes: ["M", "L", "XL", "XXL"],
    colors: [
      { name: { en: "Charcoal Black", km: "ធ្យូងខ្មៅ" }, hex: "#201f1e" },
      { name: { en: "Sand Beige", km: "ខ្សាច់លឿង" }, hex: "#cdbfa0" },
      { name: { en: "Deep Denim Navy", km: "ខៀវខូវប៊យជ្រៅ" }, hex: "#232c42" },
      { name: { en: "Olive Green", km: "បៃតងអូលីវ" }, hex: "#47502f" },
    ],
    images: [
      img("1784535191147_3023714816477841166_g2624158010987206290_46f57ea2498e58adaaef07c0e4e0de68.jpg"),
      img("1784535191380_3023714816477841166_g2624158010987206290_be5b9700339d999b7fc7071f153869ce.jpg"),
      img("1784535191627_3023714816477841166_g2624158010987206290_b1dfd39eede534e5855e052b0a3c8dab.jpg"),
      img("1784535191796_3023714816477841166_g2624158010987206290_2d93819f08cda7095202cded7e5e6807.jpg"),
    ],
    stock: 26,
    isNew: true,
  },
  {
    id: "p26",
    slug: "performance-tank-shorts-set",
    sku: "NV-SH-026",
    category: "shirts",
    name: { en: "Performance Tank & Shorts Set", km: "ឈុតអាវយឺតគ្មានដៃ និងខោខ្លី កីឡា" },
    description: {
      en: "A sleeveless performance tank paired with matching shorts in breathable stretch fabric — built for the gym floor and just as sharp for a quick errand after.",
      km: "ឈុតអាវយឺតគ្មានដៃសម្រាប់ហាត់ប្រាណ ផ្គុំជាមួយខោខ្លីដូចគ្នា ធ្វើពីក្រណាត់ទាញបន្តិចដកដង្ហើមស្រួល — ស័ក្តិសមសម្រាប់កន្លែងហាត់ប្រាណ និងកិច្ចការក្រៅផ្ទះ។",
    },
    care: { en: "Polyester-spandex blend. Machine wash cold, do not tumble dry.", km: "ប៉ូលីស្ទើរលាយស្ប៉ាន់ដិច។ លាងម៉ាស៊ីនទឹកត្រជាក់ កុំបង្ហោចក្តៅ។" },
    price: 17,
    sizes: ["M", "L", "XL", "XXL"],
    colors: [
      { name: { en: "Black", km: "ខ្មៅ" }, hex: "#101010" },
      { name: { en: "Navy", km: "ខៀវចាស់" }, hex: "#1c2a4a" },
      { name: { en: "White", km: "ស" }, hex: "#f0f0ee" },
    ],
    images: [
      img("1784684855612_2889591867796236769_g2624158010987206290_e52e9133a2f6bc2f00ede452a9978689.jpg"),
      img("1784684856229_2889591867796236769_g2624158010987206290_e52e6f6b0077fd48c711ed3cee42a22c.jpg"),
      img("1784684856941_2889591867796236769_g2624158010987206290_fc88b6c9080dd457a60289680909eb45.jpg"),
    ],
    stock: 32,
    isNew: true,
  },
  {
    id: "p27",
    slug: "phoenix-embroidered-tang-shirt",
    sku: "NV-SH-027",
    category: "shirts",
    name: { en: "Phoenix Embroidered Tang Shirt", km: "អាវតាំងស្នាដៃដេរ សត្វហ្វីនិច" },
    description: {
      en: "A mandarin-collar Tang-style shirt in soft linen-cotton, featuring a gold-embroidered phoenix motif, frog buttons, and a contrasting navy panel with a garden pavilion emblem.",
      km: "អាវតាំងកអាវឈរ ធ្វើពីលីនកប្បាសទន់ តុបតែងដោយស្នាដៃដេររូបភាពសត្វហ្វីនិចពណ៌មាស ប៊ូតុងចងជាប់ និងផ្នែកក្រណាត់ពណ៌ខៀវផ្ទុយគ្នា មានស្លាកសញ្ញារូបសួនច្បារ។",
    },
    care: { en: "Linen-cotton blend. Hand wash cold, hang dry.", km: "លីនកប្បាសលាយ។ លាងដៃទឹកត្រជាក់ ព្យួរឱ្យស្ងួត។" },
    price: 17,
    sizes: ["M", "L", "XL", "XXL"],
    colors: [
      { name: { en: "Ivory White", km: "ស ក្រែម" }, hex: "#f2ede0" },
      { name: { en: "Terracotta Rust", km: "ត្នោតឥដ្ឋ" }, hex: "#a85a34" },
      { name: { en: "Stone Grey", km: "ប្រផេះថ្ម" }, hex: "#9a9b9c" },
      { name: { en: "Onyx Black", km: "ខ្មៅអូនិច" }, hex: "#17140f" },
    ],
    images: [
      img("1785826915069_4112337030071464169_g2624158010987206290_eeba4d56a154d58fd13a6981bce7ca8e.jpg"),
      img("1785826915760_4112337030071464169_g2624158010987206290_28e52f1d577464e2317cd513edc7f1da.jpg"),
      img("1785826916472_4112337030071464169_g2624158010987206290_276b0bcde4bfded6f8ed2b0d240ffa7c.jpg"),
      img("1785826917703_4112337030071464169_g2624158010987206290_77f10f55ca71d14bb2290848eac2cba4.jpg"),
    ],
    stock: 18,
    isNew: true,
  },
